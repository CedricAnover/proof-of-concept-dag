...
dag_tasker = (
    DagTasker(result_io)
    .add_task(cb_1, 5, 3)
    .add_task(cb_2, "Foo Bar", depends_on=["cb_1"], raise_error=False)
    .add_task(cb_3, 3, kwg1=5, depends_on=["cb_2", "cb_1"], get_deps=True)
    .add_task(cb_4, depends_on=["cb_1"], get_deps=True)
)
